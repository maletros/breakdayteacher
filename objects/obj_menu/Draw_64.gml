...
var positions = [
    [605, 450], // Posição para "Iniciar partida"
    [995, 457], // Posição para "Opções"
    [275, 464]  // Posição para "Sair"
];

// Definir a cor #00bc2a
var custom_green = make_color_rgb(0, 188, 42);
...
for (var i = 0; i < op_max; i++) {
    ...
    if (i == 0) {
        ...
        draw_text(pos_x, pos_y + line_spacing, line2);
